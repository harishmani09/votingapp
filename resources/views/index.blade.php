                ...
                <div class="container">
                    ...
                    <footer class="flex justify-between items-center mt-6">
                        ...
                        <footer class="flex space-x-2">
                            <button
                                class="py-2 px-4 rounded-lg text-center font-bold uppercase leading-none w-28 h-7 text-xs bg-slate-200">open</button>
            ...
            <div class="flex space-x-6">
                ...
                <div class="container">
                    ...
                    <footer class="flex justify-between items-center mt-6">
                        ...
                        <footer class="flex space-x-2">
                            <button
                                class="py-2 px-4 rounded-lg text-center font-bold uppercase leading-none w-28 h-7 text-xs text-white bg-red ">closed</button>
                            <button x-data="{ open: false }" class="border rounded-full">
