...
class GravatarTest extends TestCase
{
 ...
 /** @test */
 public function user_can_generate_gravatar_default_image_when_no_email_first_character_a()
 {
    $user = User::factory()->create([
        'name' => 'Harish',
        'email' => 'afakemail@gmail.com'
 ...
 /** @test */
 public function user_can_generate_gravatar_default_image_when_no_email_first_character_z()
 {
    $user = User::factory()->create([
        'name' => 'Harish',
        'email' => 'zfakemail@gmail.com'
    ]);
 ...
 /** @test */
 public function user_can_generate_gravatar_default_image_when_no_email_first_character_9()
 {
    $user = User::factory()->create([
        'name' => 'Harish',
        'email' => '9fakemail@gmail.com'
    ]);
